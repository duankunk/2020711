...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<lable>省</lable><select name=\"Province\" class=\"form-control col-4\" id='Province'></select>");
	_self.append("<lable>市</lable><select name=\"city\" class=\"form-control col-4\" id='city'></select>");
	_self.append("<lable>区</lable><select name=\"area\" class=\"form-control col-4\" id='area'></select>");
	//分别获取3个下拉框
