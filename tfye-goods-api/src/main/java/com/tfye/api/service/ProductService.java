...
public interface ProductService {
	 ...
	 */
	@RequestMapping("/add")
	public Map<String , Object> saveAdmin(@RequestParam("photo") String photo,@RequestParam("name") String name,@RequestParam("price") String price,
			@RequestParam("discount") double discount, @RequestParam("describe")  String describe, @RequestParam("over")  String over,
